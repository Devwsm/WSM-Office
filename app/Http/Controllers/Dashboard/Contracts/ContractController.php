 ...
 * prototype: file disimpan di storage server (disk private `PrivateFile`,
...
class ContractController extends Controller
{
    ...
    public function store(ContractRequest $request)
    {
        ...
        $data['file_path'] = PrivateFile::store($file, 'contracts/' . $data['employee_id']);
    ...
    /**
     * Alirkan file kontrak ke user yang berhak (gate `module:contracts,view`
     * di route). File tersimpan di disk private, tidak punya URL publik.
     */
    public function file(EmployeeContract $contract)
    {
        return PrivateFile::response($contract->file_path, $contract->original_filename);
    }
