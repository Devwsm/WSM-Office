 ...
 *
 * (Dipindah 2026-09-08 ke file ini sendiri — sebelumnya class ini
 * kepakai nimpa isi `app/Http/Requests/Employee/StoreLeaveRequestRequest.php`
 * secara gak sengaja pas development Fase 7, jadi class ini gak pernah
 * kebaca autoload Composer sesuai nama file yang benar, dan versi asli
 * `StoreLeaveRequestRequest` sempat ketiban hilang.)
 * ---------------------------------------------------------------------
 */
